...
public:
  ...
  virtual boolean lock(pixmap& p) = 0;
  virtual boolean unlock() = 0;

  virtual void blt()  = 0;  // blit visible buffer to screen
  virtual void flip() = 0;  // make active buffer visible

  virtual void clear(PIXEL color) = 0;
