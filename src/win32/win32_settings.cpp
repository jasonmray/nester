...
#define NES_PREFERENCES_SAVERAMDIRTYPE_VALUE_NAME       "SaveRamDirType"
#define NES_PREFERENCES_SAVERAMOTHERDIR_VALUE_NAME      "SaveRamOtherDir"
#define NES_PREFERENCES_SAVESTATEDIRTYPE_VALUE_NAME     "SaveStateDirType"
#define NES_PREFERENCES_SAVESTATEOTHERDIR_VALUE_NAME    "SaveStateOtherDir"
...
#define NES_SOUND_SAMPLESIZE_VALUE_NAME                 "SampleSize"
...
#define NES_SOUND_EXTERNAL_VALUE_NAME                   "External"
...
void SaveNESSettings(HKEY nester_key, NES_settings& settings)
{
  ...
  try {
    ...
    SAVE_SETTING(NES_preferences_key, settings.preferences.auto_frameskip, REG_BOOLEAN, NES_PREFERENCES_AUTOFRAMESKIP_VALUE_NAME);
    ...
    SAVE_SETTING(NES_preferences_key, settings.preferences.saveRamDir, REG_SZ, NES_PREFERENCES_SAVERAMOTHERDIR_VALUE_NAME);
    ...
    SAVE_SETTING(NES_preferences_key, settings.preferences.saveStateDir, REG_SZ, NES_PREFERENCES_SAVESTATEOTHERDIR_VALUE_NAME);
  ...
  try {
    ...
    // save settings
    SAVE_SETTING(NES_graphics_key, settings.graphics.osd.double_size, REG_BOOLEAN, NES_GRAPHICS_DOUBLESIZE_VALUE_NAME);
    ...
    SAVE_SETTING(NES_graphics_key, settings.graphics.draw_overscan, REG_BOOLEAN, NES_GRAPHICS_DRAWOVERSCAN_VALUE_NAME);
    SAVE_SETTING(NES_graphics_key, settings.graphics.fullscreen_on_load, REG_BOOLEAN, NES_GRAPHICS_FULLSCREENONLOAD_VALUE_NAME);
    SAVE_SETTING(NES_graphics_key, settings.graphics.fullscreen_scaling, REG_BOOLEAN, NES_GRAPHICS_FULLSCREENSCALING_VALUE_NAME);
