...
2002.02.02 - public beta 4a
 - binary has *not* changed
 - updated email address
 - added GPL header to src/win32/win32_directory.*

2001.01.27 - public beta 4
...
Ctrl + a number key (0-9) selects a savestate "slot"
...
TAKEDA, toshiya for his work on the unofficial nester
...
accomplish this are clearly labeled in the source (see "version.h").

This file must accompany any distribution of nester source code and/or binaries,
